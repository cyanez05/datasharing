...
This is a guide for anyone who needs to share data with a statistician or data scientist. The target audiences I have in mind are:NO DEBERIA SER CUALQUIERA SE REQUIEREN CIERTOS REQUISITOS :) ... 
